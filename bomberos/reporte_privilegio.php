...
// Cabecera de página
	function Header() {
		$this->SetTitle(utf8_decode('Listado de Roles'));
		...
		$this->setXY(60, 40);
		$this->Cell(100, 8, 'Lista de Roles', 0, 1, 'C', 0);
...
// --------------------METODO PARA ADAPTAR LAS CELDAS------------------------------
	...
	function CheckPageBreak($h, $setX) {
		...
		if ($this->GetY() + $h > $this->PageBreakTrigger) {
			...
			$this->Cell(60, 8, 'Descripcion', 1, 0, 'C', 0);
			$this->Cell(80, 8, 'Estado', 1, 1, 'C', 0);
...
$pdf->Cell(40, 8, utf8_decode('Descripción'), 1, 0, 'C', 0);
...
$pdf->SetWidths(array(10, 40, 40, 35)); //???
