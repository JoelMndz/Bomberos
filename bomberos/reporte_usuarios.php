...
// Cabecera de página
	function Header() {
		$this->SetTitle(utf8_decode('Listado de Usuarios'));
		...
		$this->setXY(100, 35);
		$this->Cell(100, 8, 'Lista de Usuarios', 0, 1, 'C', 0);
...
$pdf->Cell(30, 8, utf8_decode('Cedula'), 1, 0, 'C', 0);
$pdf->Cell(30, 8, utf8_decode('Nombre'), 1, 0, 'C', 0);
$pdf->Cell(30, 8, utf8_decode('Apellidos'), 1, 0, 'C', 0);
$pdf->Cell(30, 8, utf8_decode('Dirección'), 1, 0, 'C', 0);
$pdf->Cell(25, 8, utf8_decode('Teléfono'), 1, 0, 'C', 0);
$pdf->Cell(30, 8, utf8_decode('Correo'), 1, 0, 'C', 0);
$pdf->Cell(25, 8, utf8_decode('F. Nac.'), 1, 0, 'C', 0);
$pdf->Cell(20, 8, 'Estado', 1, 0, 'C', 0);
$pdf->Cell(20, 8, utf8_decode('Rol'), 1, 0, 'C', 0);
$pdf->Cell(25, 8, utf8_decode('Rango'), 1, 1, 'C', 0);
...
$pdf->SetAligns(array('C','C','L','L','L','C','L','C','C','C','C'));
...
for ($i = 0; $i < count($data); $i++) {
	...
	$data[$i]['id_rol'], 
	$data[$i]['id_rango'],  
	ucwords(strtolower(utf8_decode($data[$i]['estado'])))), 2);
}
